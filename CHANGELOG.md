...
* **增加了简易词典存放校对过的旧词典词条，增加用户词典和查询表支持**

### 20251118 汉化精简版

* **适配了 53.XX+ 版，精简了一些功能以方便维护和增加跨版本支持**
* 删除了上下文支持，同时删除了需要上下文的翻译（如日期）和对齐支持（如菜单）
* 删除了标记文本支持，同时删除了帮助部分的翻译
* 添加了全局变量和函数搜索，允许配置搜索参数
* 简化了需要配置的字段偏移
* 改用「123 云盘」发布以方便下载
